...
public class V1_19_R2AdvancementWrapper extends AbstractAdvancementWrapper {

    public V1_19_R2AdvancementWrapper(String key, JsonObject json) {
        super(key, json);
    }

    public V1_19_R2AdvancementWrapper(String key) {
        super(key);
    }
    ...
    public void register() {
        ...
        AdvancementDataWorld advancementDataWorld = minecraftServer.ay();
    ...
    public boolean grant(Player player) {
        ...
        Advancement advancement = ((CraftServer) Bukkit.getServer()).getServer().ay().a(new MinecraftKey(super.getKey()));
        if (advancement == null) {
