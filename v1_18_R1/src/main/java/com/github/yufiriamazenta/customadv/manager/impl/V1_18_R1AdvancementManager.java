...
import com.github.yufiriamazenta.customadv.adv.V1_18_R1AdvancementWrapper;
...
public enum V1_18_R1AdvancementManager implements IAdvancementManager {

    INSTANCE;

    @Override
    public AbstractAdvancementWrapper advancementWrapper(String key, JsonObject jsonObject) {
        return new V1_18_R1AdvancementWrapper(key, jsonObject);
    }

    @Override
    public AbstractAdvancementWrapper advancementWrapper(String key) {
        return new V1_18_R1AdvancementWrapper(key);
    }
