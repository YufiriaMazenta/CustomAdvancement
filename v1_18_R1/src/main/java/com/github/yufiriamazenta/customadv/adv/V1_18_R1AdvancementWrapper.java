...
public class V1_18_R1AdvancementWrapper extends AbstractAdvancementWrapper {

    public V1_18_R1AdvancementWrapper(String key, JsonObject json) {
        super(key, json);
    }

    public V1_18_R1AdvancementWrapper(String key) {
        super(key);
    }
    ...
    public void register() {
        ...
        AdvancementDataWorld advancementDataWorld = minecraftServer.ax();
        Advancements advancements = advancementDataWorld.c;
        LootPredicateManager lootPredicateManager = minecraftServer.aH();
    ...
    public boolean grant(Player player) {
        ...
        Advancement advancement = ((CraftServer) Bukkit.getServer()).getServer().ax().a(new MinecraftKey(super.getKey()));
        if (advancement == null) {
