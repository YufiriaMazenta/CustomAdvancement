...
public class V1_19_R1AdvancementWrapper extends AbstractAdvancementWrapper {

    public V1_19_R1AdvancementWrapper(String key, JsonObject json) {
        super(key, json);
    }

    public V1_19_R1AdvancementWrapper(String key) {
        super(key);
    }
