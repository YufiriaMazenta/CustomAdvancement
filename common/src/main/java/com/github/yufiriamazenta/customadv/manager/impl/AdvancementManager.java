...
public enum AdvancementManager {
...
//            AdvancementTree advancementList = (AdvancementTree) serverAdvancementsField.get(advancementManager);
//            if (!AbstractAdvancement.getInstance().getNmsVersion().equals("v1_20_R2")) {
//                Collection<AdvancementHolder> advancementHolders = new ArrayList<>();
//                advancements.forEach((key, val) -> {
//                    advancementHolders.add(val.build(key));
//                });
//                addAdvancementMethod.invoke(advancementList, advancementHolders);
//            } else {
...
//            MinecraftServer server = (MinecraftServer) getServerMethod.invoke(null);
//            ServerAdvancementManager serverAdvancementManager = (ServerAdvancementManager) getServerAdvancementsMethod.invoke(server);
//            AdvancementTree advancementList = (AdvancementTree) serverAdvancementsField.get(serverAdvancementManager);
...
//        try {
//            String nmsVer = AbstractAdvancement.getInstance().getNmsVersion();
...
//            if (!AbstractAdvancement.getInstance().getNmsVersion().equals("v1_20_R2"))
//                addAdvancementMethod = AdvancementTree.class.getMethod(methodNameMap.get("addAdvancement").get(nmsVer), Map.class);
//            else
//                addAdvancementMethod = AdvancementTree.class.getMethod(methodNameMap.get("addAdvancement").get(nmsVer), Collection.class);
//            removeAdvancementMethod = AdvancementTree.class.getMethod(methodNameMap.get("removeAdvancement").get(nmsVer), Set.class);
...
//            getRootsAdvancementsMethod = AdvancementTree.class.getMethod(methodNameMap.get("getRoots").get(nmsVer));
...
//        getServerMethodNameMap.put("v1_20_R2", "getServer");
...
//        getLootDataMethodNameMap.put("v1_20_R2", "aH");
...
//        getServerAdvancementsMethodNameMap.put("v1_20_R2", "az");
...
//        addAdvancementMethodNameMap.put("v1_20_R2", "a");
...
//        removeAdvancementMethodNameMap.put("v1_20_R2", "a");
...
//        getAdvancementMethodNameMap.put("v1_20_R2", "a");
...
//        getPlayersMethodNameMap.put("v1_20_R2", "ac");
...
//        getRootsAdvancementMethodNameMap.put("v1_20_R2", "b");
...
//        getPlayerAdvancementsMethodNameMap.put("v1_20_R2", "M");
...
//        savePlayerAdvancementsMethodNameMap.put("v1_20_R2", "b");
...
//        reloadPlayerAdvancementsMethodNameMap.put("v1_20_R2", "a");
...
//        getOrStartProgressMethodNameMap.put("v1_20_R2", "b");
...
//        awardPlayerAdvancementMethodNameMap.put("v1_20_R2", "a");
...
//        revokePlayerAdvancementMethodNameMap.put("v1_20_R2", "b");
...
//        advancementProgressIsDoneMethodNameMap.put("v1_20_R2", "a");
...
//        getAdvancementProgressRemainingCriteriaMethodNameMap.put("v1_20_R2", "e");
...
//        advancementProgressHasProgressMethodNameMap.put("v1_20_R2", "b");
...
//        getAdvancementProgressCompletedCriteriaMethodNameMap.put("v1_20_R2", "f");
...
//        advancementFromJsonMethodNameMap.put("v1_20_R2", "a");
...
//        getDisplayMethodNameMap.put("v1_20_R2", "d");
...
//        treeNodeRunMethodNameMap.put("v1_20_R2", "a");
...
//        serverAdvancementsFieldNameMap.put("v1_20_R2", "c");
...
//        serverPlayerListFieldNameMap.put("v1_20_R2", "k");
