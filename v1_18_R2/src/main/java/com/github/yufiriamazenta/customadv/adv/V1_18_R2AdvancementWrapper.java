...
public class V1_18_R2AdvancementWrapper extends AbstractAdvancementWrapper {

    public V1_18_R2AdvancementWrapper(String key, JsonObject json) {
        super(key, json);
    }

    public V1_18_R2AdvancementWrapper(String key) {
        super(key);
    }
    ...
    public void register() {
        ...
        LootPredicateManager lootPredicateManager = minecraftServer.aG();
